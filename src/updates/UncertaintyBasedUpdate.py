...
class UncertaintyBasedUpdate:
    def __init__(self, bias_strength=0, trust=1, rewire_probability=0, tolerance=1, 
    ...
    def testing(self, belief, input, belief_uncertainty0, input_uncertainty0):
        return filtered_gaussian_multiplication_explicit_update(belief, input, self.bias_strength)
